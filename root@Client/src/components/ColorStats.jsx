...
{icons}
  ...
  <div className="flex bg-yellow-500 justify-center items-center rounded-full ring-2 ring-yellow-300  w-24 h-24"><p class="text-4xl bg-white flex justify-center items-center w-16 h-16 text-center rounded-full  text-purple-600">{score}</p></div>
